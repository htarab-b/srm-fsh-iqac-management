...
class FormDetailsModel(models.Model):
    ...
    LetterTo = models.CharField(max_length=65)
    LetterThrough = models.CharField(max_length=65)
    Date = models.DateField(default=datetime.datetime.today)
    EventDate_From = models.DateField()
    EventDate_To = models.DateField()
    AdditionalDocuments = models.CharField(max_length=255)
